...
/**
 * Persistent post-checkout confirmation page. Unlike the old ephemeral inline
 * success state, this is a real, bookmarkable route reached by id, so a refresh
 * or "back" keeps the confirmation. Reuses OrderDetailView with confirmation
 * mode for the success banner.
 */
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading || !isLoaded ? (
          <div className="flex items-center justify-center py-24">
            <SareeLoader size="lg" text="Confirming your order..." />
          </div>
        ) : error || !order ? (
          <div className="max-w-md mx-auto text-center py-24">
            ...
            <p className="mt-2 text-sm text-gray-500">
              {error || "We couldn't load this order. Check your account for order history."}
            </p>
            <Link href="/account" className="btn-primary mt-6">View my orders</Link>
          </div>
        ) : (
